                                ...
                                <div style={{
                                    ...
                                    <div style={{ textAlign: 'center' }}>
                                        <div style={{
                                            width: '120px',
                                            height: '120px',
                                            border: data.profile_image ? '4px solid #1976d2' : '4px dashed #1976d2',
                                            borderRadius: '50%',
                                            background: data.profile_image ? `url(${URL.createObjectURL(data.profile_image)}) center/cover` : '#f3f7ff',
                                            color: '#1976d2',
                                            display: 'flex',
                                            alignItems: 'center',
                                            justifyContent: 'center',
                                            ...
                                            {!data.profile_image && <PersonIcon sx={{ fontSize: '32px' }} />}
                                        </div>
                                        <Button
                                            component="label"
                                            variant="outlined"
                                    ...
                                    <div style={{
                                        ...
                                        <Box sx={{ position: 'relative' }}>
                                            ...
                                            >
                                                パスワード<span style={{ color: '#d32f2f', marginLeft: '4px' }}>*</span>
                                            </Typography>
                                            <LockIcon sx={{ 
                                                position: 'absolute',
                                                left: '16px',
                                            ...
                                            <TextField
                                                ...
                                                helperText={errors.password || '英数字を含む8文字以上'}
                                                fullWidth
                                                required
                                        ...
                                        <Box sx={{ position: 'relative' }}>
                                            ...
                                            >
                                                パスワード確認<span style={{ color: '#d32f2f', marginLeft: '4px' }}>*</span>
                                            </Typography>
                                            <LockIcon sx={{ 
                                                position: 'absolute',
                                                left: '16px',
